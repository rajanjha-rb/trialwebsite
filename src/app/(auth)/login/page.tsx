...
import { FaEye, FaEyeSlash, FaEnvelope, FaLock, FaGlobe } from "react-icons/fa";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-gold-50 p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Welcome back to your travel journey</p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-sm">
              ...
              <Link href="/register" className="font-semibold hover:underline transition-colors" style={{ color: PALETTE.blue }}>
                Create one
              </Link>
            </p>
          </div>
